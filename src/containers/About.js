...
const About = () => {
    ...
    return (
        <div id="about">
            ...
            <p>As a natural problem solver, I quickly discovered that programming is not only something that I enjoy but that suits my skillset. On the recommendation of a friend (a respected industry CTO, you know who you are!), I applied to CodeClan's immersive Professional Software Development course. As a student at CodeClan, I have been gaining valuable programming knowledge every single day and am excited about being back in the tech industry, developing my skills while pursuing my career as a software engineer.</p>
